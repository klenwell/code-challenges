...
var $author$project$Forms$Password = function (a) {
	return {$: 'Password', a: a};
};
...
var $author$project$Forms$viewInput = F4(
...
var $author$project$Forms$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Forms$init, update: $author$project$Forms$update, view: $author$project$Forms$view});
_Platform_export({'Forms':{'init':$author$project$Forms$main(
