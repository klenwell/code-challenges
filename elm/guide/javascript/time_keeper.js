...
var $author$project$TimeKeeper$view = function (model) {
...
var $author$project$TimeKeeper$main = $elm$browser$Browser$element(
	{init: $author$project$TimeKeeper$init, subscriptions: $author$project$TimeKeeper$subscriptions, update: $author$project$TimeKeeper$update, view: $author$project$TimeKeeper$view});
_Platform_export({'TimeKeeper':{'init':$author$project$TimeKeeper$main(
